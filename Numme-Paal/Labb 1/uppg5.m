...
% vi plottar funktionen mellan -5 och 5
x = -5:5;
plot(x, f(x))
...
% itererar med newton-raphson för att hitta nollställe för funktionen
format compact
for i = [0.1, 2]
    x = i;
    h = 10;
    ...
    % iterar tills förändringsvärdet (h) är mindre än en miljontedel
    % relativt x
